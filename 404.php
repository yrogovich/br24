...
<div class="stars">
		...
		<div class="central-body">
			<img class="image-404" src="<? bloginfo('template_url') ?>/src/img/icons/404.svg" width="300px">
			<p>Похоже вы потерялись <br> в космосе</p>
			<a href="<?php echo get_home_url(); ?>" class="btn-go-home">Вернуться домой</a>
		</div>
		<div class="objects">
